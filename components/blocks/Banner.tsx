        ...
        <section className='relative flex flex-col w-ful sm:min-h-screen pt-[72px] lg:pt-[68px] xl:pt-[84px] pb-[32px] lg:pb-[60px]'>
            <div className='flex items-center grow w-full max-w-[630px] md:max-w-[720px] lg:max-w-[886px] px-[20px] py-[32px] lg:py-[60px] m-auto'>
                <div className='relative w-full'>
                    <Title className='text-center max-w-[350px] sm:max-w-full m-auto mb-[24px] last:mb-0'>
                        Start monitoring your website like a pro
                    </Title>

                    <Content className='text-center mb-[32px] md:mb-[24px] last:mb-0'>
                        Get a birds eye view with our customizable dashboard. Stay on top of things! Revamp your work
                    ...
                    <div className='block sm:flex items-center justify-center gap-[40px]'>
                        <ButtonLink href='/' className='mb-[24px] sm:mb-0'>
                            Try for free
                        </ButtonLink>

                        <SimpleLink href='/' className='justify-center'>
                            View Pricing
                        </SimpleLink>
                    </div>
                </div>
            ...
            <div className='block xl:flex items-center justify-between w-full max-w-[1440px] px-[20px] lg:px-[40px] xl:px-[80px] m-auto'>
                <Content className='w-full lg:w-auto text-center xl:text-left text-[#36485C] mb-[20px] sm:mb-[24px] xl:mb-0 last:mb-0'>
